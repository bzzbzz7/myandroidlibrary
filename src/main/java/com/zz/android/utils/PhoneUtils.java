...
public class PhoneUtils {
    ...
    public static void getContantNum() {
        ...
        /*
         * Intent intent = new Intent(); intent.setAction("android.intent.action.PICK");
         * intent.setType("vnd.android.cursor.dir/phone_v2"); startActivityForResult(intent, 0);
         * 
         * @Override protected void onActivityResult ( int requestCode, int resultCode, Intent data){
         * super.onActivityResult(requestCode, resultCode, data); if (data != null) { Uri uri = data.getData(); String
         * num = null; // 创建内容解析者 ContentResolver contentResolver = getContentResolver(); Cursor cursor =
         * contentResolver.query(uri, null, null, null, null); while (cursor.moveToNext()) { num =
         * cursor.getString(cursor.getColumnIndex("data1")); } cursor.close(); num = num.replaceAll("-",
         * "");//替换的操作,555-6 -> 5556 } }
         */
    }
